...
class SiamUnet_conc(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.decoder4 = DecoderBlock(self.num_channels[4]+self.num_channels[3], self.num_channels[3], self.num_channels[2], with_conv2=True)
        ...
        self.decoder3 = DecoderBlock(self.num_channels[3]+self.num_channels[2], self.num_channels[2], self.num_channels[1], with_conv2=True)
        ...
        self.decoder2 = DecoderBlock(self.num_channels[2]+self.num_channels[1], self.num_channels[1], self.num_channels[0])
        ...
        self.decoder1 = DecoderBlock(self.num_channels[1]+self.num_channels[0], self.num_channels[0], out_channels)
...
if __name__ == '__main__':
    ...
    siamunet_cat=SiamUnet_conc(3,10).cuda()
